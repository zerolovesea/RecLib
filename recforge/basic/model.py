...
from recforge.basic.callback import EarlyStopper
from recforge.basic.features import DenseFeature, SparseFeature, SequenceFeature
from recforge.basic.metrics import configure_metrics, evaluate_metrics

from recforge.data import get_column_data
from recforge.basic.loggers import setup_logger, colorize
from recforge.utils import get_optimizer_fn, get_scheduler_fn
from recforge.loss import get_loss_fn
...
class BaseModel(nn.Module):
    ...
    def _validate_task_configuration(self):
        ...
        from recforge.loss import VALID_TASK_TYPES
        from recforge.basic.metrics import CLASSIFICATION_METRICS, REGRESSION_METRICS
...
class BaseMatchModel(BaseModel):
    ...
    def compile(self, 
        ...
        """
        from recforge.loss import validate_training_mode
