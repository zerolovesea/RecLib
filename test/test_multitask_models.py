...
class TestShareBottom:
    ...
    def test_share_bottom_initialization(self, sample_dense_features, sample_sparse_features,
    ...
    def test_share_bottom_forward_pass(self, sample_dense_features, sample_sparse_features,
    ...
    def test_share_bottom_task_outputs(self, sample_dense_features, sample_sparse_features,
...
class TestMMOE:
    ...
    def test_mmoe_initialization(self, sample_dense_features, sample_sparse_features,
                                 sample_sequence_features, device):
    ...
    def test_mmoe_forward_pass(self, sample_dense_features, sample_sparse_features,
                              sample_sequence_features, sample_multitask_batch_data,
                              device, batch_size, set_random_seed):
    ...
    def test_mmoe_with_different_expert_numbers(self, sample_dense_features, sample_sparse_features,
                                                 sample_sequence_features, device, batch_size, num_experts):
...
class TestPLE:
    ...
    def test_ple_initialization(self, sample_dense_features, sample_sparse_features,
                               sample_sequence_features, device):
    ...
    def test_ple_forward_pass(self, sample_dense_features, sample_sparse_features,
                             sample_sequence_features, sample_multitask_batch_data,
                             device, batch_size, set_random_seed):
    ...
    def test_ple_with_different_levels(self, sample_dense_features, sample_sparse_features,
                                       sample_sequence_features, device, batch_size, num_levels):
...
class TestESMM:
    ...
    def test_esmm_initialization(self, sample_dense_features, sample_sparse_features,
                                 sample_sequence_features, device):
    ...
    def test_esmm_forward_pass(self, sample_dense_features, sample_sparse_features,
                              sample_sequence_features, sample_multitask_batch_data,
                              device, batch_size, set_random_seed):
        ...
        assert torch.all(ctcvr_output <= ctr_output + 1e-5), \
            "CTCVR should be less than or equal to CTR"
        
        logger.info("ESMM forward pass successful")
    
    def test_esmm_ctcvr_constraint(self, sample_dense_features, sample_sparse_features,
                                   sample_sequence_features, device, batch_size, set_random_seed):
        ...
        # Check constraint
        assert torch.allclose(actual_ctcvr, expected_ctcvr, atol=1e-5), \
...
class TestMultiTaskModelsComparison:
    ...
    def test_models_output_consistency(self, sample_dense_features, sample_sparse_features,
                                       sample_sequence_features, device, batch_size):
